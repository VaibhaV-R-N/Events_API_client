...
export default function Signup() {
    ...
    return (
        <div className='mt-5 flex flex-col items-center justify-center gap-5 absolute left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 w-full lg:w-1/2 h-auto p-5  rounded-md shadow-lg shadow-black'>
